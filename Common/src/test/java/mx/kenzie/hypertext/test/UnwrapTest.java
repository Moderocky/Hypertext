...
public class UnwrapTest {
    ...
    public void contents() throws IOException {
        ...
        assert page.toString()
                   .equals(
                       "<html><head><title>hello there!</title></head><body><p>What's your name ?</p><p>Hello <a> " +
                           "there!\n        </a></p></body></html>");
    ...
    public void attributes() throws IOException {
        ...
        assert page.toString()
                   .equals(
                       "<html lang=\"en\"><head><title>hello there!</title><meta name=\"description\" content=\"My " +
                           "description.\" /><meta name=\"keywords\" content=\"some, words\" /></head><body><p " +
                           "class=\"card-text text-danger\">Beans</p></body></html>");
    ...
    public void css() throws IOException {
        ...
        assert page.toString()
                   .equals(
                       "h1.thing {border: 0 0 3em 3em;color: red;font-family: 'JetBrains Mono' sans-serif;}#id.thing " +
                           "> p {}");
    }
    ...
    public void mixed() throws IOException {
        ...
        assert page.toString()
                   .equals(
                       "<html lang=\"en\"><head><title>hello there!</title><meta name=\"description\" content=\"My " +
                           "description.\" /><style>h1.thing {color: red;}#id.thing > p {color: blue;border-bottom: " +
                           "1px solid black;}</style></head><body><p class=\"card-text " +
                           "text-danger\">Beans</p></body></html>");
    }
